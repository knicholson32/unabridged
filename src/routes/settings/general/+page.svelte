...
<div>
	...
	<p class="mt-1 text-sm leading-6 text-gray-500">
		...
		<a
			class="font-mono"
			href="https://github.com/knicholson32/unabridged/commit/{data.version}"
			target="_blank">@{data.version.substring(0, 7)}</a
		>
	</p>
</div>
