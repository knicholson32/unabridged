...
export type ObjectType<T extends TypeName> = T extends 'progress.running'
	? boolean // Boolean
	: T extends 'progress.paused'
	? boolean // Boolean
	: T extends 'progress.startTime'
	? number // Integer
	: T extends 'progress.endTime'
	? number // Integer
	: T extends 'progress.startPaused'
	? boolean // Integer
	: T extends 'search.autoSubmit'
	? boolean // Boolean
	: T extends 'system.debug'
	? number // Integer
	: T extends 'system.cron.enable'
	? boolean // Boolean
	: T extends 'system.cron.maxRun'
	? number // Integer
	: T extends 'system.cron.record'
	? string // String
	: T extends 'system.cron'
	? string // String
	: T extends 'plex.enable'
	? boolean // Boolean
	: T extends 'plex.apiTimeout'
	? number // Integer
	: T extends 'plex.address'
	? string // String
	: T extends 'plex.token'
	? string // String
	: T extends 'plex.library.id'
	? string // String
	: T extends 'plex.library.key'
	? string // String
	: T extends 'plex.library.name'
	? string // String
	: T extends 'plex.friendlyName'
	? string // String
	: T extends 'plex.machineId'
	? string // String
	: T extends 'plex.collections.enable'
	? boolean // Boolean
	: T extends 'plex.collections.by'
	? types.CollectionBy // Enum
	: T extends 'plex.collections.groupSingles'
	? boolean // Boolean
	: T extends 'plex.collections.singlesKey'
	? string // String
	: T extends 'plex.library.autoScan.enable'
	? boolean // Boolean
	: T extends 'plex.library.autoScan.timeout'
	? number // Integer
	: T extends 'plex.library.autoScan.delay'
	? number // Integer
	: T extends 'plex.library.autoScan.scheduled'
	? boolean // Boolean
	: T extends 'plex.library.autoScan.nextRun'
	? number // Integer
	: T extends 'plex.library.autoScan.inProgress'
	? boolean // Boolean
	: T extends 'plex.library.autoScan.progress'
	? number // Float
	: T extends 'plex.library.collection.progress'
	? number // Float
	: T extends 'library.location'
	? string // String
	: T extends 'general.autoSync'
	? boolean // Boolean
	: T extends 'general.encKey'
	? string // String
	: T extends 'general.timezone'
	? string // String
	: string;
