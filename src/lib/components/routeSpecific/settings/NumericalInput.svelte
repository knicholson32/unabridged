...
<Frame {title} {hoverTitle} error={form?.success === false && form?.name === name ? form.message ?? null : null}>
	...
	<div
		class="-my-2 flex rounded-md shadow-sm ring-1 min-w-[16em] {disabled ? 'cursor-not-allowed bg-gray-50 text-gray-500 ring-gray-200' : 'ring-gray-300'} ring-inset focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
