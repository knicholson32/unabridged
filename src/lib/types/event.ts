...
namespace Event {
	...
	export namespace Base {
		...
		export type Type<T extends Name> = T extends 'notification.created'
			? Notifications
			: T extends 'notification.deleted'
			? string[]
			: T extends 'processor.invalidate'
			? boolean
			: T extends 'processor.settings'
			? types.API.Types.ProcessSettings
			: T extends 'collection.result'
			? types.ScanAndGenerate | null
			: T extends 'collection.scheduled'
			? number
			: never;
	...
	export namespace Progress {
		...
		export type Type<T extends Name> = T extends 'basic.account.sync'
			? Basic
			: T extends 'basic.collection.scan'
			? Basic
			: T extends 'processor.book'
			? Processor.BOOK
			: never;
