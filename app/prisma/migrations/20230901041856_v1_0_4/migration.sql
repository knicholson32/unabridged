/*
  ...
  - Added the required column `result` to the `processQueue` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_processQueue" ("bookAsin", "download_progress", "downloaded_mb", "id", "in_progress", "process_progress", "speed", "total_mb", "try_after_time") SELECT "bookAsin", "download_progress", "downloaded_mb", "id", "in_progress", "process_progress", "speed", "total_mb", "try_after_time" FROM "processQueue";
