...
<tr>
  ...
  <td title="{book.genres.map(g => g.tag).join(', ')}" class="max-w-[150px] max-h-3 {tableXPadding} py-2 text-sm font-medium whitespace-nowrap table-cell truncate space-x-1">
  ...
  <td class="{tableXPadding} py-2 text-sm whitespace-nowrap">
    <div class="max-w-[150px]">
      {#if book.subtitle === null && book.description === null}
        <h4 title="By {book.authors[0].name}" class="text-gray-700 dark:text-gray-200 overflow-hidden truncate">By {book.authors[0].name}</h4>
        <p title="Narrated by {book.narrators[0].name}" class="text-gray-500 dark:text-gray-400 overflow-hidden truncate">
          Narrated by {book.narrators[0].name}
        </p>
      ...
      {:else if book.subtitle !== null && book.description === null}
        ...
        <p title="{book.authors[0].name}" class="text-gray-500 dark:text-gray-400 overflow-hidden truncate">
          {book.authors[0].name}
        </p>
      {:else}
        <h4 title="{book.subtitle}" class="text-gray-700 dark:text-gray-200 overflow-hidden truncate">{book.subtitle}</h4>
