...
export class RunTime {
    ...
    constructor(options: {min?: number, s?: number}) {
        if (options.s !== undefined) {
            ...
            throw new Error(`Must set a value of either seconds or minutes for RunTime. See options in constructor.`);
        }
    }
 ...
 */
export const joinWithLimit = (arr: string[], limit: number, join: string = ', ', postText = 'and others'): string => {
