          ...
          <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-[#1A1A1A] px-6 pb-4 ring-1 ring-white/10">
            ...
            <nav class="flex flex-1 flex-col">
              <ul role="list" class="flex flex-1 flex-col gap-y-7">
                ...
                {/if}
                <li class="mt-auto">
                  <a href="/settings" on:click={closeMobileMenu} class="{$page.url.pathname === '/settings' ? subMenuActive : subMenuDefault} group -mx-2 flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-400 hover:bg-gray-800 hover:text-white">
                    <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
